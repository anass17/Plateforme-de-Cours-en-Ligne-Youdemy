...
<body>
    ...
    <div class="py-16 max-w-[1250px] mx-auto px-3">
        <h1 class="mb-12 font-semibold text-4xl text-center">List of Reviews</h1>

        <div class="grid grid-cols-3 gap-10">
            <div>
                <div class="gap-5 flex justify-start items-center mb-1 relative w-full">
                    <div class="rounded-full mb-2 w-16 h-16 border-2 border-[#00A5CF]">
                        <img src="" alt="">
                    </div>
                    <div class="text-left flex-1">
                        <h3 class="font-semibold">Anass Boutaib</h3>
                        <span class="text-gray-600 text-sm text-left -mt-1 block">15 Jul 2025</span>
                    </div>
                ...
                <p class="text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur maxime totam laborum consectetur itaque est?</p>
            </div>
            <div>
                <div class="gap-5 flex justify-start items-center mb-1 relative w-full">
                    <div class="rounded-full mb-2 w-16 h-16 border-2 border-[#00A5CF]">
