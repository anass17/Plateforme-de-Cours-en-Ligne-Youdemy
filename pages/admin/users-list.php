...
<body class="bg-blue-100">
    ...
    <div class="py-16 text-center max-w-[1250px] mx-auto px-3">
        ...
        <div class="flex filter-tabs gap-3 *:rounded *:w-24 *:h-9 *:border justify-center mb-16 *:shadow *:bg-white text-gray-600 *:font-semibold *:text-sm hover:*:bg-gray-100 transition-colors">
            ...
            <button type="button" class="">Teachers</button>
            <button type="button" class="">Students</button>
            <button type="button" class="">Active</button>
            <button type="button" class="">Pending</button>
            <button type="button" class="">Banned</button>
        </div>
        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <?php foreach($usersList as $user): ?>
                ...
                <div class="gap-5 flex justify-start items-center mb-3 relative w-full bg-white px-5 shadow py-5 rounded">
                    ...
                    <div class="text-left flex-1">
                        ...
                        <div class="flex justify-between">
                            <span class="text-gray-600 text-sm text-left font-bold"><?php echo ucfirst($user -> getRole()); ?></span>
